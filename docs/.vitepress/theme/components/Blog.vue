...
<template>
    <div class="flex w-full flex-col gpa-5  justify-center items-center">
        ...
        <div class="w-full h-screen bg-fixed bg-cover bg-center flex justify-center items-center flex-col gap-16 relative"
            :style="{ 'background-image': `url(${theme.blog.img})` }">
        ...
        <div class="flex mt-20 justify-center items-center gap-5 flex-col w-full">
            <a :href="withBase(post.url)" class="w-full flex justify-center items-center" v-for="post of posts">
                <div
                    ...
                    <div class="flex justify-between w-full items-center">
                        ...
                        <div class="flex justify-end items-end gap-2">
                            <span class="cursor-pointer hover:underline underline-offset-4 text-[var(--vp-c-indigo-1)]"
